...
##      </Heading>
##
##      <Meth Name="Beltify" Label="for an arrow, +/-1 and a list of integers"
##      Arg="arr, N, int_list"/>
##      <Meth Name="Beltify" Label="for a path of a special biserial algebra"
##      Arg="path"/>
##      <Description>
...
##    <ManSection>
##      <Oper Name="WidthOfBelt" Arg="belt"/>
##      <Description>
##        Argument: <A>belt</A>, a belt
##        <Br />
##      </Description>
##      <Returns>
##        a nonnegative integer, counting the number (with multiplicity) of
##        syllables of <A>belt</A> are nonstationary.
##      </Returns>
##    </ManSection>
##  <#/GAPDoc>
...
##    <ManSection>
##      <Oper Name="WidthNBeltsOfSBAlg" Arg="N, sba"/>
##      <Description>
...
##      </Description>
##      <Returns>
##        a list, comprising all the belts of width <A>N</A> over <A>sba</A>
##      </Returns>
##      <Description>
##        Recall that the belts of width <M>0</M> are the simple belts and
##        those of width <M>1</M> are the nonsimple uniserial belts.
##      </Description>
##    </ManSection>
##  <#/GAPDoc>
