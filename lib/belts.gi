...
InstallOtherMethod(
    ...
    function(belt1, belt2)
        local
            ...
            data1, data2,           # Defining data of <belt1> and <belt2>
...
InstallGlobalFunction(
    ...
    function(arg)
        ...
        # Now we create the <IsBeltRep> object.
...
InstallMethod(
    ...
    [IsList],
    function(data)
        # This function is like an inverse to <PathAndOrientationListOfBeltNC>
...
InstallMethod(
    ...
    function(belt)
        local
            data,       # Syllable and orientation list in <belt>
            ...
            gens,       # Arrow-indexed list of matrices corresponding to the
                        #  <field>-linear maps described by <belt>
            is_nonnull_mat,
            ...
            sba,        # SB algebra to which <belt> belongs
        ...
        # Our first step is to unpack the data of <belt>. We
